...
function getErrorMessage($errorCode)
{
    switch ($errorCode) {
        ...
        case "weak-password":
            return "The password that you have entered is too weak.<br/>It should be at least 10 characters long and contain at least one symbol from each of the following groups: capital letters (A-Z), small letters (a-z), digits (0-9) and special characters (*, ^, %, $, ?, etc).";
        default :
